...
from agentgate.trust.runtime.container_inspector import ContainerInspector
from agentgate.trust.runtime.http_prober import HttpProber
...
def _seccomp_profile_path() -> str | None:
    ...
    try:
        ref = importlib.resources.files("agentgate.trust.runtime").joinpath(
